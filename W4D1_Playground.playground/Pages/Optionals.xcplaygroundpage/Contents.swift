 ...
 */
//var nonOptional: String = nil error
...
//optional = nil does not work because you already assigned it a value making it not optional anymore
/*:
 ...
 */
//var stringWithDigits = "no"
var stringWithDigits = "3.2"
var doubleFromString = Double(stringWithDigits)
/*:
 - Experiment:
 With your newly converted `Double` from a `String`, try multiplying it with the 'ratio' variable. What happens?
 */
//var result = doubleFromString*ratio not unwrapped error
...
*/
print("\(doubleFromString!)") // no error
/*:
 - Experiment:
 Go back and change your `String` to something that has no digits. What happens and why?
 */
// fatal error because doubleFromString is set to nil since it doesn't have any digits
 ...
 */
var optionalString: String? = "initial string"
print(optionalString)
print(optionalString!)
// it prints the word Optional with my string in brackets
/*:
 - Experiment:
 ...
 */
var notOptionalString = "not optional"
optionalString = notOptionalString
print(optionalString)
/*:
 ...
 */
// doesn't allow the gravityConstant to be unwrapped
 ...
 */
var arrayOfLetters = ["c", "b", "e", "i", "o"]
print("first: \(arrayOfLetters.first!) last: \(arrayOfLetters.last!)")
/*:
 - Experiment:
 ...
 */
print("indexOf method: \(arrayOfLetters.index(of: "b")!)")
